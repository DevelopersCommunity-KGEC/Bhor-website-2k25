          ...
          <g id="Layer_2" data-name="Layer 2">
            <g>
              ...
              <motion.path
                ...
                transition={transition}
                className="cls-1"
                d="M238.9,136c-.2.4-.4.8-.5,1.1s-.2.7-.2,1.1,0,.9.2,1.2.4.7.7,1,.6.5,1,.7.8.2,1.2.2.4,0,.6,0,.4-.1.6-.2l.5-.3,2.1,1h0c-.5.4-1,.8-1.6,1.1s-1.1.7-1.6,1-1.1.7-1.6,1.1-.9.7-1.3,1.1-.7.8-.9,1.3-.3.9-.3,1.4,0,.7.2,1,.3.6.6.9.5.5.9.7.7.3,1.1.3l1.7,1.8h0c-1,.6-2,1-3,1.2s-1.9.3-2.8.3-1.7,0-2.4-.3-1.5-.5-2.1-.8-1.2-.7-1.8-1.2-1-1-1.3-1.6-.6-1.2-.8-1.8-.3-1.3-.3-2,.2-2,.6-3,1-2.2,1.8-3.3,1.7-2.2,2.9-3.2,2.4-2,3.9-2.9l2.1,1.1h0ZM229.9,147.3c0,.8.1,1.5.4,2.2s.7,1.3,1.3,1.8,1.3.9,2.1,1.2,1.8.4,2.9.4.6,0,.9,0c-.3-.3-.6-.6-.9-.9s-.5-.7-.7-1-.3-.7-.5-1.1-.2-.7-.2-1.1c0-.5.1-1.1.3-1.6s.5-1,.8-1.4.8-.9,1.2-1.3,1-.8,1.5-1.2c-.5-.2-.9-.4-1.3-.7s-.8-.6-1.1-1-.5-.8-.7-1.3-.2-1-.2-1.5v-.3c0,0,0-.2,0-.3-.9.7-1.7,1.4-2.5,2.2s-1.4,1.5-1.9,2.3-1,1.6-1.3,2.3-.5,1.6-.5,2.3Z"
              />
            </g>
          </g>
        </svg>
